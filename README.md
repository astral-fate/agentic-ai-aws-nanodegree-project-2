...
[`cloudshell/deploy-e2e-v9.sh`](cloudshell/deploy-e2e-v9.sh) is **self-contained** —
...
```bash
bash deploy-e2e-v9.sh --status      # what exists, change nothing
...
cloudshell/
  deploy-e2e-v9.sh            ★ self-contained one-command deploy + all six tests
